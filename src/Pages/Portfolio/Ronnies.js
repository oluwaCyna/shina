      ...
      <Header content = {content} />
        <div>
            ...
            <div className={singlePorfolioStyle.mainContainer}>
                ...
                <img src={ '/ronnie/Thumbnail.png' } alt={'ronnieshouseforhope.org'} className={singlePorfolioStyle.headerImg} />
                <img src={ '/ronnie/1.png' } alt={'ronnieshouseforhope.org'} className={singlePorfolioStyle.headerImg} />
                <img src={ '/ronnie/2.png' } alt={'ronnieshouseforhope.org'} className={singlePorfolioStyle.headerImg} />
                <img src={ '/ronnie/3.png' } alt={'ronnieshouseforhope.org'} className={singlePorfolioStyle.headerImg} />
                <img src={ '/ronnie/4.png' } alt={'ronnieshouseforhope.org'} className={singlePorfolioStyle.headerImg} />
