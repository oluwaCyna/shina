      ...
      <Header content = {content} />
        <div>
            ...
            <div className={singlePorfolioStyle.mainContainer}>
                ...
                <img src={ '/radical/Thumbnail.png' } alt={'radicalgrief.org'} className={singlePorfolioStyle.headerImg} />
                <img src={ '/radical/1.png' } alt={'radicalgrief.org'} className={singlePorfolioStyle.headerImg} />
                <img src={ '/radical/2.png' } alt={'radicalgrief.org'} className={singlePorfolioStyle.headerImg} />
                <img src={ '/radical/3.png' } alt={'radicalgrief.org'} className={singlePorfolioStyle.headerImg} />
                </div>
