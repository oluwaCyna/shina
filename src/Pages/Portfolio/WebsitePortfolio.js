      ...
      <Header content = {content} />
        <div>
            ...
            <div className={singlePorfolioStyle.mainContainer}>
                ...
                <img src={ '/portfolio/Thumbnail.png' } alt={'Portfolio'} className={singlePorfolioStyle.headerImg} />
                <img src={ '/portfolio/1.png' } alt={'Portfolio'} className={singlePorfolioStyle.headerImg} />
                <img src={ '/portfolio/2.png' } alt={'Portfolio'} className={singlePorfolioStyle.headerImg} />
                <img src={ '/portfolio/3.png' } alt={'Portfolio'} className={singlePorfolioStyle.headerImg} />
                <img src={ '/portfolio/4.png' } alt={'Portfolio'} className={singlePorfolioStyle.headerImg} />
