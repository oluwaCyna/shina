      ...
      <Header content = {content} />
        <div>
            ...
            <div className={singlePorfolioStyle.mainContainer}>
                ...
                <img src={ '/commerce/Thumbnail.png' } alt={'E-commerce Website'} className={singlePorfolioStyle.headerImg} />
                <img src={ '/commerce/1.png' } alt={'E-commerce Website'} className={singlePorfolioStyle.headerImg} />
                <img src={ '/commerce/2.png' } alt={'E-commerce Website'} className={singlePorfolioStyle.headerImg} />
                <img src={ '/commerce/3.png' } alt={'E-commerce Website'} className={singlePorfolioStyle.headerImg} />
                <img src={ '/commerce/4.png' } alt={'E-commerce Website'} className={singlePorfolioStyle.headerImg} />
