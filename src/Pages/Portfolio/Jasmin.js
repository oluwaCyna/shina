      ...
      <Header content = {content} />
        <div>
            ...
            <div className={singlePorfolioStyle.mainContainer}>
                ...
                <img src={ '/jasmin/Thumbnail.png' } alt={'jasminshah.com'} className={singlePorfolioStyle.headerImg} />
                <img src={ '/jasmin/1.png' } alt={'jasminshah.com'} className={singlePorfolioStyle.headerImg} />
                <img src={ '/jasmin/2.png' } alt={'jasminshah.com'} className={singlePorfolioStyle.headerImg} />
                <img src={ '/jasmin/3.png' } alt={'jasminshah.com'} className={singlePorfolioStyle.headerImg} />
                <img src={ '/jasmin/4.png' } alt={'jasminshah.com'} className={singlePorfolioStyle.headerImg} />
